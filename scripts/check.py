...
for file in ['assets/site.js','assets/config.js','assets/gallery.js','assets/booking.js','assets/retreat.js','assets/guest-experience.js','assets/hero-motion.js']:subprocess.run(['node','--check',str(root/file)],check=True)
